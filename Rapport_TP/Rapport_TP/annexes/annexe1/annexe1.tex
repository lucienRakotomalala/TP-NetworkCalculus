\chapter*{Annexe 1 - Tableau de données}
\addcontentsline{toc}{chapter}{Tableau de données}
%\setcounter{section}{0}
% **********************************
\addcontentsline{toc}{section}{TITRE}
\label{Annex:Tableau de donnees}
\lstset{
...
\begin{center}
\includegraphics[scale=.75]{./annexes/annexe1/calculsNetworkCalculus.pdf}
\end{center}